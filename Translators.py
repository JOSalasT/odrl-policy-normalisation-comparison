...
class LogicTranslator():
    def __init__(self):
        ...
        self.conjunction = "∧"
        self.disjunction = "∨"
        self.actionTypes = data_helper.get_actions_from_odrl("./ontology/default_ontology/ODRL22.rdf")
        self.actorTypes = data_helper.get_actors_from_dpv("./ontology/default_ontology/dpv.rdf")
        self.purposeTypes = data_helper.get_purposes_from_dpv("./ontology/default_ontology/dpv.rdf")
